...
public class GatewayConfig {
    ...
    public RouteLocator routeLocator(RouteLocatorBuilder builder) {
        return builder.routes()
                .route("auth-swagger", r -> r.path("/emergency/api/v1/auth/swagger-ui/**", "/emergency/api/v1/auth/v3/api-docs/**")
                        .uri("http://auth-service:8091"))
                .route("ambulance-swagger", r -> r.path("/emergency/api/v1/ambulance/swagger-ui/**", "/emergency/api/v1/ambulance/v3/api-docs/**")
                        .uri("http://ambulance-service:8092"))
                .route("emergency-swagger", r -> r.path("/emergency/api/v1/emergency-case/swagger-ui/**", "/emergency/api/v1/emergency-case/v3/api-docs/**")
                        .uri("http://emergency-service:8093"))
                .route("hospital-swagger", r -> r.path("/emergency/api/v1/hospital/swagger-ui/**", "/emergency/api/v1/hospital/v3/api-docs/**")
                        .uri("http://hospital-service:8094"))
                .route("route-swagger", r -> r.path("/emergency/api/v1/route/swagger-ui/**", "/emergency/api/v1/route/v3/api-docs/**")
